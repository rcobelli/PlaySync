            ...
            VStack(alignment: .leading) {
                ScrollView(.vertical) {
                    ...
                    HStack {
                        ...
                        Spacer()
                        Text("\(selectedChannels.count)").font(.title2)
                            .foregroundStyle(
                                selectedChannels.count == 4 ? .green : .black
                            )
                    }
                    ...
                    HStack {
                        ...
                        Button("\(Image(systemName: "gear"))", action: promptForIP)
                                        ...
                                        Button(
                                            action: {
                                                if selectedChannels.contains(ch)
                                                {
                                                    ...
                                                    selectedChannels.insert(
                                                        ch,
                                                        at: 0
                                                    )
                                                }

                                                startPlaybackFocused =
                                                    selectedChannels.count == 4
                                            },
                                            label: {
                                                VStack {
                                                    ThumbnailGenerator(
